...
from pytorch_transformers import (WEIGHTS_NAME, BertConfig,
                                  ...
                                  load_tf_weights_in_bert, BERT_PRETRAINED_MODEL_ARCHIVE_MAP, BertModel,
...
from utils_glue import (compute_metrics, metrics_with_thresh, convert_examples_to_features)
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {'input_ids':      batch[0],
             ...
             #   loss = model(inputs[input_ids], inputs[token_type_ids], inputs[attention_mask], inputs[labels])
            #else: 
...
def main():
    ...
    if(args.task_name == "multilabel"):
        model_class = BertForMultiLabelSequenceClassification
